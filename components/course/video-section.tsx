      ...
      <div className="mb-4">
        ...
        <div className="mt-3 flex flex-row justify-between">
          <button
            ...
            className="flex w-40 items-center justify-center gap-2 rounded-md bg-fsPurple px-3 py-2 text-white"
          >
          ...
          <div className="flex gap-1">
            <button
              ...
              className="flex w-40 items-center justify-center gap-2 rounded-md border border-fsPurple bg-white px-3 py-2 text-fsPurple"
            >
