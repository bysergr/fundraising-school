...
export const AgendaIcon = ({ stroke }: IconProps) => {
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
      <path
        d="M21 10.5V6.5C21 5.96957 20.7893 5.46086 20.4142 5.08579C20.0391 4.71071 19.5304 4.5 19 4.5H5C4.46957 4.5 3.96086 4.71071 3.58579 5.08579C3.21071 5.46086 3 5.96957 3 6.5V20.5C3 21.6 3.9 22.5 5 22.5H12"
        stroke={stroke}
        stroke-width="2"
